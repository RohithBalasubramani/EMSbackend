...
# from Anomaly.models import Amf2DailyKwhAnomalyTest


# class RunAmf2DailyKwhAnomalyDetection(CronJobBase):
#     RUN_AT_TIMES = ["2:45"]  # Set the desired time
#     schedule = Schedule(run_at_times=RUN_AT_TIMES)
#     code = "anomaly_detection.Amf2DailyKwh"  # A unique code for the cron job
...
#             if (record.tf3_kwh != record.og3_kwh) or (record.tf4_kwh != record.og4_kwh):
#                 anomalies.append(
#                     {
#                         "instance": record,
#                         "field": None,
...
#                 if value and value > 3 * median_values[field]:
#                     anomalies.append(
#                         {
#                             "instance": record,
#                             "field": field,
...
#                             "reason": f"Anomaly detected: Value much higher that the median ({field})",
#                         }
#                     )
...
#         # Store anomalies in the Amf2DailyKwhAnomalyTest model
#         for anomaly in anomalies:
#             Amf2DailyKwhAnomalyTest.objects.create(
