...
from Anomalydb.models import Amf1DailyKwhAnomalyDb  # Updated model name
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Store anomalies in the Amf1DailyKwhAnomalyDb model
        for anomaly in anomalies:
            Amf1DailyKwhAnomalyDb.objects.create(
